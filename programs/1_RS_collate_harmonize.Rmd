---
title: "Sky/Loch Metadata for Aquatic Surface Ref Request"
author: "B Steele"
date: "2023-03-03"
...
To get a scene list for Sky/Loch for the Provisional Aquatic SR product.
...
```{r}
uindex = unique(filtered$LANDSAT_PRODUCT_ID)
```
